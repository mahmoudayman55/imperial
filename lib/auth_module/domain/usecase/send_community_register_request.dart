...
class CommunityRegisterRequestUseCase{
  BaseAuthRepository  baseAuthRepository;

  CommunityRegisterRequestUseCase(this.baseAuthRepository);


  Future<Either<ErrorMessageModel, String>>execute(RegistrationRequest registrationRequest)async{
    return await baseAuthRepository.sendCommunityRegistrationRequest(registrationRequest);
