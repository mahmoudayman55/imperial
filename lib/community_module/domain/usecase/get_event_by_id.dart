...
class GetEventByIdUseCase{
  ...
  GetEventByIdUseCase(this.communityRepository);
  Future<Either<ErrorMessageModel, Event>>execute(int id)async{
    return await communityRepository.getEventById(id);
