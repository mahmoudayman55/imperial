...
class GetEventsUseCase{
  ...
  GetEventsUseCase(this.communityRepository);
  Future<Either<ErrorMessageModel, List<Event>>>execute(LimitParametersModel queryParameters)async{
    return await communityRepository.getEvents(queryParameters);
