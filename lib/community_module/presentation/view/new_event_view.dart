...
class NewEventView extends StatelessWidget {
  ...
  final newEventController = Get.find<NewEventController>();
              ...
              body: SafeArea(
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: GetBuilder<NewEventController>(builder: (controller) {
                                  ...
                                  CustomButton(
                                      ...
                                      onPressed: () {
                                        showDialog(
                                            context: context,
                                            builder: (c) {
                                              return GetBuilder<NewEventController>(
                                                  builder: (controller) {
                                                return Dialog(
                                                  child: Container(
