          ...
          body: SafeArea(
            child: Container(
              ...
              child: GetBuilder<EventController>(builder: (controller) {
                return Form(
                  key: controller.newEventFormKey,
                  child: Column(
                    children: [
                      Expanded(
                        flex: 14,
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              controller.selectedEvent.underFiveFree
                                  ? Column(
                                children: [
                                  Divider(),
                                  Row(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                        onPressed: () {
                                          if (controller.selectedEvent.attendees +
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${((controller.selectedEvent.underFiveFree
                                        ...
                                        .length
                                        : controller.kidsAttendees.length) *
                                        controller.selectedEvent.kidTicketPrice)
                                        .toString()} £",
                                    style: Theme
                                        .of(context)
                                        .textTheme
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${((controller.selectedEvent.underFiveFree
                                        ...
                                        controller.selectedEvent
                                            .kidTicketPrice) +
                                        ((controller.adultAttendees.length) * controller.selectedEvent
                                            .adultTicketPrice)}£",
                                    style: Theme
                                        .of(context)
                                        .textTheme
