...
import '../community_module/presentation/controller/community_profile_controller.dart';
...
class CommunityProfileView extends StatelessWidget {
  final communityProfileController = Get.find<CommunityProfileController>();
    ...
    return Sizer(builder:
      ...
      return deviceType == DeviceType.mobile
          ? Scaffold(
              ...
              body: GetBuilder<CommunityProfileController>(builder: (c) {
                return c.gettingCommunity.value
                    ? Center(
                                  ...
                                  Stack(
                                    children: [
                                      CustomCachedNetworkImage(
                                          imageUrl: communityProfileController
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              'Members (${c.selectedCommunity.membersNumber})',
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .displayLarge!
                                                  .copyWith(
                                            ...
                                            c.selectedCommunity.members.isEmpty
                                                ? InkWell(
                                                    onTap: () {},
                                                    child: Text(
                                                      "No members yet",
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Text(
                                                              c.selectedCommunity.members
                                                                      ...
                                                                      100
                                                                  ? "+99"
                                                                  : "+${c.selectedCommunity.members.length - 3}",
                                                              style: Theme.of(
                                                                      context)
                                                                  .textTheme
                                                                  .displayLarge,
                                        ...
                                        c.selectedCommunity.events.isEmpty
                                            ? Text(
                                                "No events yet",
                                                style: Theme.of(context)
                                                    .textTheme
                                              ...
                                              itemBuilder: (context, index) {
                                                return Padding(
                                                  padding: const EdgeInsets
                                                      ...
                                                      horizontal: 5.0),
                                                  child: InkWell(
                                                    onTap: () =>    Get.toNamed(AppConstants.personProfilePage,arguments:c
                                                        .selectedCommunity
                                                        .admins[index]
                                                        .id),
                              ...
                              child: Row(
                                children: [
                                  CustomButton(
                                      ...
                                      borderRadius: 0,
                                      onPressed: () {
                                        CustomUrlLauncher.launchCallApp(c
                                            .selectedCommunity.admins[0].phone);
                                      },
                                      useGradient: false,
                                      circleIcon: false,
                                      ...
                                      icon: Icons.call,
                                      label: 'Contact'),
                                  if (currentUserController.currentUser ==
                                          null ||
                                      currentUserController.currentUser!.role ==
                                          null)
                                    CustomButton(
                                        height: height * 0.1,
                                        width: width * 0.5,
                                        ...
                                        onPressed: () => c.askToJoin(),
                                        icon: c.sendingJoinRequest
                                            ? Icons.loop
                                            : Icons.app_registration,
                                        enabled: !c.sendingJoinRequest,
                                        useGradient: false,
                                        circleIcon: false,
                                        color: CustomColors.green,
                                        label: c.sendingJoinRequest
                                            ? "Loading..."
                                            : 'Ask To Join')
                                ],
                              ))
